...
## Development environment and release process
 ...
 - create virtualenv with Flask and seclopz-api installed into it (latter is installed in
...
install it (`pip install seclopzapi.tar.gz`), ensure that configuration file exists and
`SECLOPZAPI_SETTINGS` environment variable points to it, ensure that user has access to the
